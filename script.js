(function () {
  ...
  const PLATFORMS = [
    ...
    },
    {
      ...
      accent: "#e4405f",
      icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2c2.7 0 3 .01 4.04.06 1.02.05 1.58.22 1.95.37.49.19.84.42 1.21.79.37.37.6.72.79 1.21.15.37.32.93.37 1.95.05 1.04.06 1.34.06 4.04s-.01 3-.06 4.04c-.05 1.02-.22 1.58-.37 1.95-.19.49-.42.84-.79 1.21-.37.37-.72.6-1.21.79-.37.15-.93.32-1.95.37-1.04.05-1.34.06-4.04.06s-3-.01-4.04-.06c-1.02-.05-1.58-.22-1.95-.37a3.3 3.3 0 0 1-1.21-.79 3.3 3.3 0 0 1-.79-1.21c-.15-.37-.32-.93-.37-1.95C2.21 15 2.2 14.7 2.2 12s.01-3 .06-4.04c.05-1.02.22-1.58.37-1.95.19-.49.42-.84.79-1.21.37-.37.72-.6 1.21-.79.37-.15.93-.32 1.95-.37C9 2.21 9.3 2.2 12 2.2zm0 1.8c-2.65 0-2.96.01-4 .06-.98.04-1.5.2-1.86.33-.47.18-.8.4-1.15.75-.35.35-.57.68-.75 1.15-.13.35-.29.88-.33 1.86-.05 1.04-.06 1.35-.06 4s.01 2.96.06 4c.04.98.2 1.5.33 1.86.18.47.4.8.75 1.15.35.35.68.57 1.15.75.35.13.88.29 1.86.33 1.04.05 1.35.06 4 .06s2.96-.01 4-.06c.98-.04 1.5-.2 1.86-.33.47-.18.8-.4 1.15-.75.35-.35.57-.68.75-1.15.13-.35.29-.88.33-1.86.05-1.04.06-1.35.06-4s-.01-2.96-.06-4c-.04-.98-.2-1.5-.33-1.86a3.1 3.1 0 0 0-.75-1.15 3.1 3.1 0 0 0-1.15-.75c-.35-.13-.88-.29-1.86-.33-1.04-.05-1.35-.06-4-.06zm0 3.35a5.65 5.65 0 1 1 0 11.3 5.65 5.65 0 0 1 0-11.3zm0 1.8a3.85 3.85 0 1 0 0 7.7 3.85 3.85 0 0 0 0-7.7zm6.4-3.92a1.32 1.32 0 1 1-2.64 0 1.32 1.32 0 0 1 2.64 0z"/></svg>`,
    },
    {
      id: "steam",
      name: "Steam",
